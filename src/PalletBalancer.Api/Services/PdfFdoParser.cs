...
{
    // K006T91071XB (1L+3D+1L+5D+2L) | A003TV6981BC / M009TA0579ZX (1L+3D+2L+4D+2L) | W013F504BX (1L+3D+1L+3D+2L) | 3ST08H/3ST0FP/3ST0G0 (1D+2L+3AN)
    private static readonly Regex ModeloRegex = new(@"\b(?:[A-Z]\d{3}(?:[A-Z]\d{5}|[A-Z]{2}\d{4}|[A-Z]\d{3})[A-Z]{2}|\d[A-Z]{2}[A-Z0-9]{3})\b");
